...
uint const TX_ADDRESS[TX_ADR_WIDTH]= {0x01,0x01,0x01,0x01,0x01}; //本地地址	  0x01,0x01,0x01,0x01,0x01
uint const RX_ADDRESS[RX_ADR_WIDTH]= {0x10,0x10,0x10,0x10,0x10}; //接收地址	  0x10,0x10,0x10,0x10,0x10
//***************************************NRF24L01寄存器指令*******************************************************
